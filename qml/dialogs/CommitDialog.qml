...
Dialog {
    ...
    footer: DialogButtonBox {
        ...
        Label {
            text: "Draft generated by the commit model in Settings"
            opacity: 0.65
        ...
        Button {
            ...
            onClicked: {
                ...
                root.progressText = "Starting Git operation..."
                resultLabel.text = ""
                if (root.featureMode)
    ...
    Connections {
        ...
        function onCommitProgressChanged(message) {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            visible: root.busy || root.progressText.length > 0
            ProgressBar {
                Layout.fillWidth: true
            ...
            Label {
                ...
                opacity: root.progressText.length > 0 ? 0.75 : 0
            }
        }
        ...
        TextField {
            ...
            readOnly: true
            selectByMouse: true
            placeholderText: "No origin remote detected"
        ...
        TextField {
            id: subjectEdit
            Layout.fillWidth: true
            placeholderText: "Imperative summary, e.g. Fix project import crash"
            maximumLength: 120
            onTextEdited: {
        ...
        TextArea {
            ...
            placeholderText: "Optional context: why, risks, tests, or follow-up"
        ...
        GridLayout {
            ...
            TextField {
                id: branchEdit
                Layout.fillWidth: true
                placeholderText: "feature/fix-project-import"
            }
            Label { text: "Remote" }
            TextField {
                id: remoteEdit
    ...
    onOpened: {
        ...
        root.progressText = "Generating commit message..."
        root.controller.generateCommitMessage()
    }

    onRejected: {
        if (root.lockBlocked || (root.busy && !root.generating))
